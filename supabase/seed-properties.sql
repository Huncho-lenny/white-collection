...
INSERT INTO public.properties (id, slug, title, location, price_per_night, max_guests, bedrooms, bathrooms, rating, review_count, image_urls, tag, type, amenities, description, status)
VALUES
(
